...
class Env {
  ...
  static DB_PASSWORD: string = process.env.DB_PASSWORD || "agung12154";
  static DB_NAME: string = process.env.DB_NAME || "circle";
  ...
  static REDIS_PASSWORD: string = process.env.REDIS_PASSWORD || "";
}
